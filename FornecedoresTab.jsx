    ...
    <div style={{ padding:'20px' }}>
      ...
      <div style={{ display:'flex',flexWrap:'wrap',gap:12,marginBottom:20 }}>
        {[
          ...
          ['Previsto / Pendente',fmtBRL(totalPendente),C.amber],
        ].map(([lbl,val,clr])=>(
            ...
            {isExp&&(
              <div style={{ padding:16 }}>
                <div style={{ display:'flex',alignItems:'center',justifyContent:'space-between',marginBottom:10 }}>
                  <span style={{ fontSize:12,fontWeight:700,color:C.gray }}>CRONOGRAMA DE PAGAMENTOS / PREVISÕES</span>
                ...
                {pags.length===0&&!addPag&&(
                  <p style={{ fontSize:12,color:C.gray }}>Nenhuma previsão de pagamento cadastrada.</p>
                )}
